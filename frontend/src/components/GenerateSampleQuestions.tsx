      ...
      if (useAI) {
        ...
        if (aiResponse.questions && Array.isArray(aiResponse.questions)) {
          finalQuestions = aiResponse.questions.map((q: any, i: number) => ({
            ...
            explanation_hindi: q.explanation_hindi || 'कोई स्पष्टीकरण नहीं दिया गया।',
            hint: q.hint || 'No hint provided.',
            hint_hindi: q.hint_hindi || 'कोई संकेत नहीं दिया गया।',
        ...
        for (let i = 1; i <= questionCount; i++) {
          ...
          finalQuestions.push({
            ...
            explanation_hindi: `यह प्रश्न ${i} के लिए एक नमूना स्पष्टीकरण है। सही उत्तर ${String.fromCharCode(65 + correctAnswer)} है।`,
            hint: `Think about the logic for question ${i}.`,
            hint_hindi: `प्रश्न ${i} के तर्क के बारे में सोचें।`,
            category_id: selectedCategoryId,
            subject_id: selectedSubjectId,
            topic_id: selectedTopicId,
            category_ids: [selectedCategoryId],
